...
author: "Thomas Schaffter (thomas.schaffter@pm.me)"
date: "`r Sys.Date()`"
output:
  html_document:
    df_print: paged
...
One of the series of tasks benchmarked in the NLP Sandbox are PHI annotation and
...
of the 2014 i2b2 NLP De-identification Challenge and generate a new dataset
